...
from social_media_core.permissions import IsOwnerOrReadOnly, IsOwnerOnly
from user.views import CoreModelMixin
from user.models import UserProfile
from social_media_core.models import HashTag, Like, Comment, Post
from social_media_core.serializers import (
    HashTagSerializer,
    LikeSerializer,
    CommentSerializer,
    PostSerializer,
